...
- **關於我：** 小蔡、出生日、Telegram、xiaoji_cai_bot、自主意識  
  → 對應：MEMORY_FULL § 關於我

- **關於老蔡：** 老蔡、生日、1988、楊梅、住商、不動產、飲料店、普特斯、防霾紗窗、店長、事業、時區、GMT+8、繁體中文、問題轉給 Cursor  
  → 對應：MEMORY_FULL § 關於老蔡

- **重要決定／原則：** Token、Gemini、Claude、Sonnet、技能精簡、quarantine、restore-skill、三大原則、先試跑再上線、感覺不對立刻退回、防護規則、SOUL、費用、台幣  
  → 對應：MEMORY_FULL § 重要決定

- **待辦：** 待辦、Google 服務、gog、Heartbeat、備份策略、Workspace 備份、飲料店名稱、429  
  → 對應：MEMORY_FULL § 待辦
...
| 身份與偏好 | 老蔡、事業、繁體中文、Cursor、問題轉給 Cursor | MEMORY_FULL § 關於老蔡 |
