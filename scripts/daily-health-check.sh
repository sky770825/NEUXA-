#!/bin/bash
# 每日健康巡檢腳本 - 任務板 + 系統狀態
# 建議放進 crontab: 0 9 * * * /Users/caijunchang/.openclaw/workspace/scripts/daily-health-check.sh

LOG_FILE="/Users/caijunchang/.openclaw/workspace/logs/health-check-$(date +%Y%m%d).log"
